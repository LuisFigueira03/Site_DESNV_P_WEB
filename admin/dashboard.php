...
// Médicos inativos
$totalMedicosInativos = (int)$dbh->query("SELECT COUNT(*) FROM medico WHERE ativo = 0")->fetchColumn();
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-xl border-l-4 border-[#09A2AE]">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Especialistas ativos</p>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-xl border-l-4 border-gray-400">
                    <p class="text-sm font-medium text-gray-500">Médicos Inativos</p>
                    <p class="text-4xl font-bold text-gray-600 mt-2"><?= $totalMedicosInativos ?></p>
                    <p class="text-xs text-gray-400 mt-1">Especialistas inativos</p>
                </div>
