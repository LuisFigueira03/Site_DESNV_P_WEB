...
// Flags simples para saber o estado do login
$tipo_utilizador = $_SESSION['tipo_utilizador'] ?? null;
$esta_logado = !empty($tipo_utilizador);
?>
    ...
    <div class="max-w-7xl mx-auto px-6 pt-4">
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex flex-col items-end md:items-center">
                ...
                <!-- Linha com menu desktop e login/área em mobile e hamburger -->
                <div class="flex items-center gap-3">
                    ...
                    <nav class="hidden md:flex flex-wrap gap-3 items-center">
                        ...
                        <!-- ÁREA / LOGIN EM DESKTOP -->
                        <?php if ($esta_logado && $tipo_utilizador === 'utente'): ?>
                            <a href="utente.php" class="bg-[#09A2AE] text-white px-6 py-2 rounded-full font-medium hover:bg-sky-600 transition">
                                Área do utente
                            </a>
                            <a href="auth/logout.php" class="bg-red-600 text-white px-6 py-2 rounded-full font-medium hover:bg-red-700 transition">
                                Terminar sessão
                            </a>
                        <?php elseif ($esta_logado && $tipo_utilizador === 'medico'): ?>
                            <a href="medico.php" class="bg-[#09A2AE] text-white px-6 py-2 rounded-full font-medium hover:bg-sky-600 transition">
                                Área do médico
                            </a>
                            <a href="auth/logout.php" class="bg-red-600 text-white px-6 py-2 rounded-full font-medium hover:bg-red-700 transition">
                                Terminar sessão
                    ...
                    <!-- ÁREA / LOGIN EM MOBILE (botão ao lado do hamburger) -->
                    <?php if ($esta_logado && $tipo_utilizador === 'utente'): ?>
                        <a href="utente.php"
                ...
                <div class="mt-3 hidden peer-checked:flex md:hidden w-full">
                    <nav class="flex flex-col gap-2 w-full">
                        ...
                        <!-- ÁREA / LOGIN / LOGOUT EM MOBILE (dentro do menu) -->
                        <?php if ($esta_logado && $tipo_utilizador === 'utente'): ?>
                            <a href="utente.php" class="w-full text-left bg-[#09A2AE] text-white px-4 py-2 rounded-full font-medium hover:bg-sky-600 transition">
                                Área do utente
                            </a>
                            <a href="auth/logout.php" class="w-full text-left bg-red-600 text-white px-4 py-2 rounded-full font-medium hover:bg-red-700 transition">
                                Terminar sessão
                            </a>
                        <?php elseif ($esta_logado && $tipo_utilizador === 'medico'): ?>
                            <a href="medico.php" class="w-full text-left bg-[#09A2AE] text-white px-4 py-2 rounded-full font-medium hover:bg-sky-600 transition">
                                Área do médico
                            </a>
                            <a href="auth/logout.php" class="w-full text-left bg-red-600 text-white px-4 py-2 rounded-full font-medium hover:bg-red-700 transition">
                                Terminar sessão
                        ...
                        <?php else: ?>
                            <a href="login.php" class="w-full text-left bg-[#09A2AE] text-white px-4 py-2 rounded-full font-medium hover:bg-sky-600 transition">
                                Login
                            </a>
                        <?php endif; ?>
