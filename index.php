...
<section id="faq" class="py-10">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
      ...
      <div>
        ...
        <a href="formulario.php" style="background-color: #2563eb;" class="inline-flex items-center gap-2 mt-4 px-10 py-8 text-white font-semibold rounded-lg transition">
          Contactar
        </a>
      </div>

      <div class="bg-white text-black rounded-2xl shadow-lg p-6 space-y-4">
