...
INSERT INTO `ausencia_medico` (`id`, `medico_id`, `data_inicio`, `data_fim`, `motivo`, `tipo`) VALUES
	...
	(3, 9, '2025-12-16', '2025-12-17', NULL, 'ferias');
...
-- A despejar dados para tabela web2.consulta: ~15 rows (aproximadamente)
INSERT INTO `consulta` (`id`, `medico_id`, `utente_id`, `data_consulta`, `hora_inicio`, `hora_fim`, `estado`, `acordo_id`, `tipo`, `observacoes`, `created_at`, `updated_at`) VALUES
	...
	(21, 4, 8, '2025-11-05', '11:00:00', '11:30:00', 'marcada', NULL, 'presencial', '', '2025-11-20 16:41:06', NULL),
	...
	(23, 4, 8, '2025-11-30', '11:00:00', '11:30:00', 'marcada', NULL, 'presencial', '', '2025-12-06 03:27:28', NULL),
	(24, 8, 8, '2025-12-18', '11:00:00', '11:30:00', 'marcada', NULL, 'presencial', '', '2025-12-15 14:43:30', NULL),
	(25, 4, 3, '2025-12-17', '16:00:00', '16:30:00', 'marcada', 4, 'presencial', '', '2025-12-16 21:27:10', NULL);
...
-- A despejar dados para tabela web2.contacto_mensagem: ~0 rows (aproximadamente)
INSERT INTO `contacto_mensagem` (`id`, `tipo_remetente`, `utente_id`, `medico_id`, `nome`, `email`, `telemovel`, `assunto`, `mensagem_html`, `estado`, `created_at`) VALUES
	(1, 'medico', NULL, 4, 'Dra. Marta Sousa', '1@1', '915678901', 'efe', '<p>feefe</p>', 'lido', '2025-12-16 19:43:29');
...
-- A despejar dados para tabela web2.exame: ~5 rows (aproximadamente)
INSERT INTO `exame` (`id`, `consulta_id`, `tipo_exame`, `observacoes`, `codigo`, `estado`) VALUES
	...
	(4, 22, 'raio-x', 'CAbrça', '267967306403579209054808', 'pedido'),
	(5, 22, 'raio-x', 'CAbrça', '920829887564041337713753', 'pedido'),
	(6, 23, '1', NULL, '628789836618763979600632', 'pedido'),
	(7, 22, 'teste', NULL, '598392222786247821254083', 'pedido');
...
-- A despejar dados para tabela web2.feedback: ~1 rows (aproximadamente)
INSERT INTO `feedback` (`id`, `utente_id`, `nome`, `estrelas`, `comentario`, `criado_em`) VALUES
	(1, 8, 'ola', 5, 'teste', '2025-12-16 23:27:18');
...
INSERT INTO `medico` (`id`, `nome`, `num_cedula`, `email`, `password_hash`, `telemovel`, `especialidade_id`, `ativo`) VALUES
	...
	(11, 'João Silvaefefefe', '1234111', 'olagfgfgfg@gmail.com', '$2y$10$jqlOC5Lm5K2AzIfVNu6p2ONHsbKCPzf3OkdYXeVSOah.zD14ngSBS', '222220911', 2, 1);
...
-- A despejar dados para tabela web2.utente: ~8 rows (aproximadamente)
INSERT INTO `utente` (`id`, `nome`, `email`, `telemovel`, `num_utente_saude`, `nif`, `data_nascimento`, `password_hash`, `email_verificado`, `acordo_id`, `created_at`, `updated_at`, `sexo`, `morada`, `peso_kg`, `altura_cm`, `imc`, `tipo_sanguineo`, `alergias`, `observacoes`, `foto`) VALUES
	...
	(8, 'ola', 'ola@gmail.com', '2', '12', '123', '2025-11-05', '$2y$10$TJcjDc8N5Q71y/amTzlqtO8tLNGifA7k4NlaGlZgPkArNIUGDTmri', 0, NULL, '2025-11-18 20:30:41', '2025-12-15 14:41:46', 'F', 'Ruas', 12.00, 16, 468.80, 'efe', 'efe', 'efe', NULL),
	(9, 'ede', 'eded@gmail.com', NULL, NULL, NULL, NULL, '$2y$10$Db5oFjJL74cmbdbcumYeA.gw5q2H7H55rUEiDsVIBnLx/iMcKjg0e', 0, NULL, '2025-12-06 02:28:37', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
